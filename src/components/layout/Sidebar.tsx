...
export function Sidebar() {
  ...
  return (
    <aside className="fixed left-0 top-0 h-screen w-72 border-r border-white/5 bg-staff-surface/90 backdrop-blur-xl p-6 flex flex-col justify-between z-50 hidden lg:flex">
